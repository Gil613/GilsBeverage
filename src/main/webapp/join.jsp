...
action="join.do" onsubmit="return checkValue()">
	<table>
		...
		<td>
		 ...
		 <tr>
			 <td>
			 	  <input type="text" name="ph1" max="3">
			 	- <input type="text" name="ph2" max="4">
			 	- <input type="text" name="ph3" max="4">
			 </td>
		 </tr>
	...
	<input type="button" value="취소" onclick="location.href='calender.jsp'">
	<br><br>
	</form>
